...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-4">
            <div class="card">
                <p>This post was published {{$thread->created_at->diffForHumans()}} by <a href="#">{{$thread->creator->name}}</a> and has {{$thread->reply_count}} {{str_plural('comment', $thread->reply_count)}}.</p>
            </div>
        </div>
    </div>
